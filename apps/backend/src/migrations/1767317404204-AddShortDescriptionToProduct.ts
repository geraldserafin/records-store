...
export class AddShortDescriptionToProduct1767317404204 implements MigrationInterface {
    name = 'AddShortDescriptionToProduct1767317404204'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`products\` ADD \`shortDescription\` text NULL`);
