...
export class AddArtistAndGenre1767441411774 implements MigrationInterface {
    name = 'AddArtistAndGenre1767441411774'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`artists\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`bio\` text NULL, \`image\` varchar(255) NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`genres\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`slug\` varchar(255) NOT NULL, \`description\` text NULL, UNIQUE INDEX \`IDX_f105f8230a83b86a346427de94\` (\`name\`), UNIQUE INDEX \`IDX_d1cbe4fe39bdfc77c76e94eada\` (\`slug\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`product_artists\` (\`productsId\` int NOT NULL, \`artistsId\` int NOT NULL, INDEX \`IDX_a296f84d83835bb7e0aa7efe6b\` (\`productsId\`), INDEX \`IDX_200f419b8b39c9064651af1a8f\` (\`artistsId\`), PRIMARY KEY (\`productsId\`, \`artistsId\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`product_genres\` (\`productsId\` int NOT NULL, \`genresId\` int NOT NULL, INDEX \`IDX_f5889ae79d35ef2ed6948f7bde\` (\`productsId\`), INDEX \`IDX_cb639611206907e0295a546876\` (\`genresId\`), PRIMARY KEY (\`productsId\`, \`genresId\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`product_artists\` ADD CONSTRAINT \`FK_a296f84d83835bb7e0aa7efe6bd\` FOREIGN KEY (\`productsId\`) REFERENCES \`products\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`product_artists\` ADD CONSTRAINT \`FK_200f419b8b39c9064651af1a8fe\` FOREIGN KEY (\`artistsId\`) REFERENCES \`artists\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`product_genres\` ADD CONSTRAINT \`FK_f5889ae79d35ef2ed6948f7bdee\` FOREIGN KEY (\`productsId\`) REFERENCES \`products\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE \`product_genres\` ADD CONSTRAINT \`FK_cb639611206907e0295a546876d\` FOREIGN KEY (\`genresId\`) REFERENCES \`genres\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`product_genres\` DROP FOREIGN KEY \`FK_cb639611206907e0295a546876d\``);
        await queryRunner.query(`ALTER TABLE \`product_genres\` DROP FOREIGN KEY \`FK_f5889ae79d35ef2ed6948f7bdee\``);
        await queryRunner.query(`ALTER TABLE \`product_artists\` DROP FOREIGN KEY \`FK_200f419b8b39c9064651af1a8fe\``);
        await queryRunner.query(`ALTER TABLE \`product_artists\` DROP FOREIGN KEY \`FK_a296f84d83835bb7e0aa7efe6bd\``);
        await queryRunner.query(`ALTER TABLE \`orders\` DROP FOREIGN KEY \`FK_151b79a83ba240b0cb31b2302d1\``);
        await queryRunner.query(`ALTER TABLE \`order_items\` DROP FOREIGN KEY \`FK_cdb99c05982d5191ac8465ac010\``);
        await queryRunner.query(`ALTER TABLE \`order_items\` DROP FOREIGN KEY \`FK_f1d359a55923bb45b057fbdab0d\``);
        await queryRunner.query(`ALTER TABLE \`products\` DROP FOREIGN KEY \`FK_ff56834e735fa78a15d0cf21926\``);
        ...
        await queryRunner.query(`ALTER TABLE \`category_attribute\` DROP COLUMN \`options\``);
        await queryRunner.query(`ALTER TABLE \`category_attribute\` ADD \`options\` longtext COLLATE "utf8mb4_bin" NULL DEFAULT 'NULL'`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_9f3c1f1cb07f205f2876bbfc1f\` ON \`category_attribute\` (\`name\`, \`categoryId\`)`);
        await queryRunner.query(`ALTER TABLE \`category_attribute\` ADD CONSTRAINT \`FK_6ae9fd1960af2eb3b290036c1c8\` FOREIGN KEY (\`categoryId\`) REFERENCES \`product_category\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`review\` ADD CONSTRAINT \`FK_1e758e3895b930ccf269f30c415\` FOREIGN KEY (\`authorId\`) REFERENCES \`users\`(\`id\`) ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`review\` ADD CONSTRAINT \`FK_2a11d3c0ea1b2b5b1790f762b9a\` FOREIGN KEY (\`productId\`) REFERENCES \`products\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`DROP INDEX \`IDX_cb639611206907e0295a546876\` ON \`product_genres\``);
        await queryRunner.query(`DROP INDEX \`IDX_f5889ae79d35ef2ed6948f7bde\` ON \`product_genres\``);
        await queryRunner.query(`DROP TABLE \`product_genres\``);
        await queryRunner.query(`DROP INDEX \`IDX_200f419b8b39c9064651af1a8f\` ON \`product_artists\``);
        await queryRunner.query(`DROP INDEX \`IDX_a296f84d83835bb7e0aa7efe6b\` ON \`product_artists\``);
        await queryRunner.query(`DROP TABLE \`product_artists\``);
